...
library(VennDiagram)
grid.newpage()
v <-draw.triple.venn(area1 = 8931, area2 = 9839, area3 = 8094, n12 = 7774, n23 = 7121, n13 = 6706,  n123 = 6290, category = c("Coastal ecotype", "Inland ecotype", "Bulk soil"), cat.cex=rep(1,3),lty = "blank",     fill = c("blue", "red", "green"),cex=rep(1,7))
...
lapply(v, function(i) i$label)
library(VennDiagram)
test<-tiff("Figure5.tiff",width=1500,height=1500, units="px")
grid.newpage()
grid.draw(v)
dev.off()
