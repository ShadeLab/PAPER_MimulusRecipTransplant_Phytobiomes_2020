...
bartlett.test(Soil_tempC ~ Site_planted, data=mim_envir)
library(car)
leveneTest(Soil_tempC ~ Site_planted, data=mim_envir)
t.test(Soil_tempC ~ Site_planted, data=mim_envir, var.equal=FALSE)
wilcox.test(~ Site_planted, paired=FALSE, data=mim_envir)

bartlett.test(Air_TempC ~ Site_planted, data=mim_envir)
library(car)
leveneTest(Air_TempC ~ Site_planted, data=mim_envir)
t.test(Air_TempC ~ Site_planted, data=mim_envir, var.equal=FALSE)
wilcox.test(~ Site_planted, paired=FALSE, data=mim_envir)
