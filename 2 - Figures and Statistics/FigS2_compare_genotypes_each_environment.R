...
cols <- c("LINE1"="royalblue4","LINE2"="royalblue1")
Fig_coastalgeno_coastalsite<-ggplot(coastalgeno_coastalsitesummary, aes(names))+
...
cols <- c("LINE1"="royalblue4","LINE2"="royalblue1")
Fig_coastalgeno_inlandsite<-ggplot(coastalgeno_inlandsitesummary, aes(names))+
...
Fig_inlandgeno_coastalsite<-ggplot(inlandgeno_coastalsitesummary, aes(names))+
...
cols <- c("LINE1"="green","LINE2"="green4")
Fig_inlandgeno_inlandsite<-ggplot(inlandgeno_inlandsitesummary, aes(names))+
...
library("gridExtra")
FigureS2 <- grid.arrange(Fig_coastalgeno_coastalsite,Fig_coastalgeno_inlandsite,Fig_inlandgeno_coastalsite,Fig_inlandgeno_inlandsite, ncol = 2,nrow=2, widths=c(3.3,2.8),heights = c(3, 3))
FigureS2
ggsave("FigureS2.tiff",FigureS2,width=300,height=174, units="mm",dpi=300)
