...
#convert otu table to data matrix then calculate distance matrix
mim_otu <- data.matrix(t(mim_otu))
mim_Jac <- as.data.frame(as.matrix(vegdist(mim_otu, method="jaccard", binary=TRUE)))


#Look at main effects of Rhizo_Bulk and Site_planted
set.seed(1)
adonis(mim_Jac~Rhizo_Bulk*Site_planted, data=mim_envir)
set.seed(1)
adonis(mim_Jac~Site_planted*Rhizo_Bulk, data=mim_envir)
...
mim_Jac_Inland <- subset(mim_Jac, select=c(Mim109, Mim181, Mim182, Mim190, Mim191, Mim1,   Mim224, Mim228 ,Mim22,  Mim237, Mim238, Mim250 ,Mim255, Mim32  ,Mim66,  Mim67  ,Mim83,  Mim87,  Mim93,  Mim98))
...
mim_Jac_Inland<-mim_Jac_Inland[(row.names(mim_Jac_Inland) %in% list), ]
#Finally, do Adonis test
set.seed(1)
adonis(mim_Jac_Inland~Site_planted, data=mim_envir_Inland)
#Homogeneity of dispersions test
dist <- as.dist(mim_Jac_Inland)
set.seed(1)
result <- betadisper(dist, mim_envir_Inland$Site_planted, type=c("centroid"))
set.seed(1)
permutest(result)

#Subset full metadata to only include coastal ecotype samples
...
mim_coastalecoonly
#select only those samples from dissimilarity matrix columns.
mim_Jac_Coastal <- subset(mim_Jac, select=c(Mim11,  Mim12,  Mim141, Mim143, Mim151, Mim152, Mim161, Mim162, Mim172, Mim176, Mim212, Mim21  ,Mim2 ,  Mim31,  Mim46,  Mim47,  Mim57,  Mim58,  Mim97))
#now do the same thing for the dissimilarity matrix rows.
...
mim_Jac_Coastal<-mim_Jac_Coastal[(row.names(mim_Jac_Coastal) %in% list), ]
#Finally, do Adonis test
set.seed(1)
adonis(mim_Jac_Coastal~Site_planted, data=mim_envir_Coastal)
#Homogeneity of dispersions test
dist <- as.dist(mim_Jac_Coastal)
set.seed(1)
...
mim_inlandonly
#select only those samples from dissimilarity matrix columns.
mim_Jac_Inland <- subset(mim_Jac, select=c(Mim109, Mim116, Mim11,  Mim124, Mim129, Mim12,  Mim132, Mim139, Mim1,   Mim21, Mim22,  Mim2,   Mim31,  Mim32,  Mim46,  Mim47,  Mim57,  Mim58,  Mim66,  Mim67, Mim83,  Mim87,  Mim93,  Mim97,  Mim98))
#now do the same thing for the dissimilarity matrix rows.
...
#Finally, do Adonis test
set.seed(1)
adonis(mim_Jac_Inland~Rhizo_Bulk, data=mim_envir_Inland)
#Homogeneity of dispersions test
dist <- as.dist(mim_Jac_Inland)
set.seed(1)
...
mim_Jac_Coastal <- subset(mim_Jac, select=c(Mim141, Mim143, Mim151, Mim152, Mim161, Mim162, Mim172, Mim176, Mim181, Mim182,Mim190, Mim191, Mim212, Mim224, Mim228, Mim237, Mim238, Mim250, Mim255, Mim261,Mim266, Mim271, Mim277, Mim286))
...
#Finally, do Adonis test
set.seed(1)
adonis(mim_Jac_Coastal~Rhizo_Bulk, data=mim_envir_Coastal)
#Homogeneity of dispersions test
dist <- as.dist(mim_Jac_Coastal)
set.seed(1)
...
#select only those samples from dissimilarity matrix columns.
mim_Jac_Inland_BulkInlandeco <- subset(mim_Jac, select=c(Mim109,Mim116,Mim124,Mim129,Mim132,Mim139,Mim1,Mim22,Mim32,Mim66,Mim67,Mim83,Mim87,Mim93,Mim98))
...
mim_Jac_Inland_BulkInlandeco<-mim_Jac_Inland_BulkInlandeco[(row.names(mim_Jac_Inland_BulkInlandeco) %in% list), ]
#Finally, do Adonis test
set.seed(1)
adonis(mim_Jac_Inland_BulkInlandeco~Rhizo_Bulk, data=mim_envir_Inland_BulkInlandeco)
#Homogeneity of dispersions test
dist <- as.dist(mim_Jac_Inland_BulkInlandeco)
set.seed(1)
...
#select only those samples from dissimilarity matrix columns.
mim_Jac_Inland_BulkCoastaleco <- subset(mim_Jac, select=c(Mim116,Mim11,Mim124,Mim129,Mim12,Mim132,Mim139,Mim21,Mim2,Mim31,Mim46,Mim47,Mim57,Mim58,Mim97))
#now do the same things for the dissimilarity matrix rows.
list <- c("Mim116", "Mim11",  "Mim124", "Mim129", "Mim12",  "Mim132" ,"Mim139", "Mim21" , "Mim2",   "Mim31", "Mim46",  "Mim47",  "Mim57",  "Mim58",  "Mim97" )
mim_Jac_Inland_BulkCoastaleco<-mim_Jac_Inland_BulkCoastaleco[(row.names(mim_Jac_Inland_BulkCoastaleco) %in% list), ]
#Finally, do Adonis test
set.seed(1)
adonis(mim_Jac_Inland_BulkCoastaleco~Rhizo_Bulk, data=mim_envir_Inland_BulkCoastaleco)
#Homogeneity of dispersions test
dist <- as.dist(mim_Jac_Inland_BulkCoastaleco)
set.seed(1)
...
mim_bulkandInlandecoonly
#select only those samples from dissimilarity matrix columns.
mim_Jac_Coastal_BulkInlandeco <- subset(mim_Jac, select=c(Mim181, Mim182 ,Mim190, Mim191, Mim224 ,Mim228 ,Mim237 ,Mim238, Mim250, Mim255,Mim261, Mim266 ,Mim271 ,Mim277, Mim286))
#now do the same things for the dissimilarity matrix rows.
list <- c("Mim181", "Mim182" ,"Mim190", "Mim191", "Mim224" ,"Mim228" ,"Mim237" ,"Mim238", "Mim250", "Mim255","Mim261", "Mim266" ,"Mim271" ,"Mim277", "Mim286")
mim_Jac_Coastal_BulkInlandeco<-mim_Jac_Coastal_BulkInlandeco[(row.names(mim_Jac_Coastal_BulkInlandeco) %in% list), ]
#Finally, do Adonis test
set.seed(1)
adonis(mim_Jac_Coastal_BulkInlandeco~Rhizo_Bulk, data=mim_envir_Coastal_BulkInlandeco)
#Homogeneity of dispersions test
dist <- as.dist(mim_Jac_Coastal_BulkInlandeco)
set.seed(1)
...
mim_bulkandCoastalecoonly
#select only those samples from dissimilarity matrix columns.
mim_Jac_Coastal_BulkCoastaleco <- subset(mim_Jac, select=c(Mim141,Mim143,Mim151,Mim152,Mim161,Mim162,Mim172,Mim176,Mim212,Mim261,Mim266,Mim271,Mim277,Mim286))
#now do the same things for the dissimilarity matrix rows.
list <- c("Mim141", "Mim143", "Mim151", "Mim152", "Mim161", "Mim162", "Mim172", "Mim176", "Mim212", "Mim261", "Mim266", "Mim271", "Mim277", "Mim286")
mim_Jac_Coastal_BulkCoastaleco<-mim_Jac_Coastal_BulkCoastaleco[(row.names(mim_Jac_Coastal_BulkCoastaleco) %in% list), ]
#Finally, do Adonis test
set.seed(1)
adonis(mim_Jac_Coastal_BulkCoastaleco~Rhizo_Bulk, data=mim_envir_Coastal_BulkCoastaleco)
#Homogeneity of dispersions test
dist <- as.dist(mim_Jac_Coastal_BulkCoastaleco)
set.seed(1)
...
mim_Jac_Inland_rhizo <- subset(mim_Jac_Inland, select=c(Mim109, Mim11,  Mim12,  Mim1,   Mim21,  Mim22,  Mim2,   Mim31,  Mim32,  Mim46, Mim47,  Mim57,  Mim58,  Mim66,  Mim67,  Mim83,  Mim87,  Mim93,  Mim97,  Mim98))
#now do the same things for the dissimilarity matrix rows.
...
mim_Jac_Inland_rhizo<-mim_Jac_Inland_rhizo[(row.names(mim_Jac_Inland_rhizo) %in% list), ]
#Finally, do Adonis test
set.seed(1)
adonis(mim_Jac_Inland_rhizo~Origin,data=mim_envir_Inland_rhizo)
#Homogeneity of dispersions test
dist <- as.dist(mim_Jac_Inland_rhizo)
set.seed(1)
...
set.seed(1)
adonis(mim_Jac_Inland_rhizo~Genotype,data=mim_envir_Inland_rhizo, strata=mim_envir_Inland_rhizo$Origin)
...
mim_Jac_Inland_rhizo_coastaleco <- subset(mim_Jac_Inland_rhizo, select=c(Mim11, Mim12, Mim21, Mim2, Mim31, Mim46, Mim47, Mim57, Mim58, Mim97))
#now do the same things for the dissimilarity matrix rows.
list <- c("Mim11", "Mim12", "Mim21", "Mim2",  "Mim31", "Mim46", "Mim47", "Mim57", "Mim58", "Mim97")
mim_Jac_Inland_rhizo_coastaleco<-mim_Jac_Inland_rhizo_coastaleco[(row.names(mim_Jac_Inland_rhizo_coastaleco) %in% list), ]
#Finally, do Adonis test
set.seed(1)
adonis(mim_Jac_Inland_rhizo_coastaleco~Genotype,data=mim_envir_Inland_rhizo_coastaleco)
...
#select only those samples from Inland rhizo dissimilarity matrix columns.
mim_Jac_Inland_rhizo_Inlandeco <- subset(mim_Jac_Inland_rhizo, select=c(Mim109, Mim1,Mim22,Mim32,  Mim66,  Mim67,  Mim83,  Mim87,  Mim93,  Mim98 ))
#now do the same things for the dissimilarity matrix rows.
list <- c("Mim109", "Mim1",   "Mim22",  "Mim32",  "Mim66",  "Mim67",  "Mim83",  "Mim87",  "Mim93",  "Mim98")
mim_Jac_Inland_rhizo_Inlandeco<-mim_Jac_Inland_rhizo_Inlandeco[(row.names(mim_Jac_Inland_rhizo_Inlandeco) %in% list), ]
#Finally, do Adonis test
set.seed(1)
adonis(mim_Jac_Inland_rhizo_Inlandeco~Genotype,data=mim_envir_Inland_rhizo_Inlandeco)

#Homogeneity of dispersions test
dist <- as.dist(mim_Jac_Inland_rhizo_Inlandeco)
set.seed(1)
result <- betadisper(dist, mim_envir_Inland_rhizo_Inlandeco$Genotype, type=c("centroid"))
set.seed(1)
permutest(result)
...
mim_Jac_Coastal_rhizo <- subset(mim_Jac_Coastal, select=c(Mim141, Mim143, Mim151, Mim152, Mim161, Mim162, Mim172, Mim176, Mim181, Mim182, Mim190, Mim191, Mim212, Mim224, Mim228, Mim237, Mim238, Mim250, Mim255))
#now do the same things for the dissimilarity matrix rows.
...
mim_Jac_Coastal_rhizo<-mim_Jac_Coastal_rhizo[(row.names(mim_Jac_Coastal_rhizo) %in% list), ]
#Finally, do Adonis test
set.seed(1)
adonis(mim_Jac_Coastal_rhizo~Origin,data=mim_envir_Coastal_rhizo)
#Homogeneity of dispersions test
dist <- as.dist(mim_Jac_Coastal_rhizo)
set.seed(1)
...
#With strata=Origin, you limit permutations (re-labeling) to be between only those samples of the same Ecotype.
set.seed(1)
adonis(mim_Jac_Coastal_rhizo~Genotype,data=mim_envir_Coastal_rhizo, strata=mim_envir_Coastal_rhizo$Origin)
...
mim_Jac_Coastal_rhizo_coastaleco <- subset(mim_Jac_Coastal_rhizo, select=c(Mim141,Mim143,Mim151,Mim152,Mim161,Mim162,Mim172,Mim176,Mim212))
#now do the same things for the dissimilarity matrix rows.
list <- c("Mim141", "Mim143", "Mim151", "Mim152", "Mim161", "Mim162", "Mim172", "Mim176", "Mim212")
mim_Jac_Coastal_rhizo_coastaleco<-mim_Jac_Coastal_rhizo_coastaleco[(row.names(mim_Jac_Coastal_rhizo_coastaleco) %in% list), ]
#Finally, do Adonis test
set.seed(1)
adonis(mim_Jac_Coastal_rhizo_coastaleco~Genotype,data=mim_envir_Coastal_rhizo_coastaleco)
...
#select only those samples from Coastal rhizo dissimilarity matrix columns.
mim_Jac_Coastal_rhizo_Inlandeco <- subset(mim_Jac_Coastal_rhizo, select=c("Mim181", "Mim182", "Mim190", "Mim191","Mim224", "Mim228", "Mim237", "Mim238", "Mim250", "Mim255"))
#now do the same things for the dissimilarity matrix rows.
list <- c("Mim181", "Mim182", "Mim190", "Mim191", "Mim224", "Mim228", "Mim237", "Mim238", "Mim250", "Mim255")
mim_Jac_Coastal_rhizo_Inlandeco<-mim_Jac_Coastal_rhizo_Inlandeco[(row.names(mim_Jac_Coastal_rhizo_Inlandeco) %in% list), ]
#Finally, do Adonis test
set.seed(1)
adonis(mim_Jac_Coastal_rhizo_Inlandeco~Genotype,data=mim_envir_Coastal_rhizo_Inlandeco)
