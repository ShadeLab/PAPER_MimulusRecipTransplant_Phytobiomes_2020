...
mim_diversity_richness <- subset(mim_diversity, select=c("Genotype", "Origin", "Site_planted","Richness"))
#reshape the data
...
#plot the data
Rich<-ggplot(mim_diversity_richness_m, aes(Genotype, value, fill=Origin))+
...
#Retain only data of interest
mim_diversity_PD <- subset(mim_diversity, select=c("Genotype", "Origin", "Site_planted","PD_whole_tree_alpha"))
#reshape the data
...
#plot the data
PD<-ggplot(mim_diversity_PD_m, aes(Genotype, value, fill=Origin))+
  facet_grid(.~Site_planted)+
  theme_bw()+
...
#Retain only data of interest
mim_diversity_Shannon <- subset(mim_diversity, select=c("Genotype", "Origin", "Site_planted","shannon_alpha"))
#reshape the data
...
#plot the data
Shannon<-ggplot(mim_diversity_Shannon_m, aes(Genotype, value, fill=Origin))+
  facet_grid(.~Site_planted)+
  theme_bw()+
...
kruskal.test(Richness~Rhizo_Bulk, data=mim_diversity_CoastalSite_InlandandBulk)
t.test(PD_whole_tree_alpha~Rhizo_Bulk,paired=FALSE, var.equal = TRUE, data=mim_diversity_CoastalSite_InlandandBulk)
kruskal.test(PD_whole_tree_alpha~Rhizo_Bulk,data=mim_diversity_CoastalSite_InlandandBulk)
t.test(shannon_alpha~Rhizo_Bulk,paired=FALSE, var.equal = TRUE, data=mim_diversity_CoastalSite_InlandandBulk)
kruskal.test(shannon_alpha~Rhizo_Bulk,data=mim_diversity_CoastalSite_InlandandBulk)
...
kruskal.test(PD_whole_tree_alpha~Rhizo_Bulk,data=mim_diversity_CoastalSite_CoastalandBulk)
t.test(shannon_alpha~Rhizo_Bulk,paired=FALSE, var.equal = TRUE, data=mim_diversity_CoastalSite_CoastalandBulk)
kruskal.test(shannon_alpha~Rhizo_Bulk,data=mim_diversity_CoastalSite_CoastalandBulk)
...
kruskal.test(PD_whole_tree_alpha~Rhizo_Bulk,data=mim_diversity_InlandSite_InlandandBulk)
t.test(shannon_alpha~Rhizo_Bulk,paired=FALSE, var.equal = TRUE, data=mim_diversity_InlandSite_InlandandBulk)
kruskal.test(shannon_alpha~Rhizo_Bulk,data=mim_diversity_InlandSite_InlandandBulk)
...
kruskal.test(PD_whole_tree_alpha~Rhizo_Bulk,data=mim_diversity_InlandSite_CoastalandBulk)
t.test(shannon_alpha~Rhizo_Bulk,paired=FALSE, var.equal = TRUE, data=mim_diversity_InlandSite_CoastalandBulk)
kruskal.test(shannon_alpha~Rhizo_Bulk,data=mim_diversity_InlandSite_CoastalandBulk)
...
kruskal.test(PD_whole_tree_alpha~Origin,data=mim_diversity_CoastalSite_Rhizosphere)
t.test(shannon_alpha~Origin,paired=FALSE, var.equal = TRUE, data=mim_diversity_CoastalSite_Rhizosphere)
kruskal.test(shannon_alpha~Origin,data=mim_diversity_CoastalSite_Rhizosphere)
...
t.test(Richness~Origin, paired=FALSE, var.equal = TRUE, data=mim_diversity_InlandSite_Rhizosphere)
kruskal.test(Richness~Origin, data=mim_diversity_InlandSite_Rhizosphere)
t.test(PD_whole_tree_alpha~Origin,paired=FALSE, var.equal = TRUE, data=mim_diversity_InlandSite_Rhizosphere)
kruskal.test(PD_whole_tree_alpha~Origin,data=mim_diversity_InlandSite_Rhizosphere)
t.test(shannon_alpha~Origin,paired=FALSE, var.equal = TRUE, data=mim_diversity_InlandSite_Rhizosphere)
kruskal.test(shannon_alpha~Origin,data=mim_diversity_InlandSite_Rhizosphere)
