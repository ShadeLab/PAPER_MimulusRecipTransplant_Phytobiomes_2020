...
mim_WU_Inland_rhizo_coastaleco<-mim_WU_Inland_rhizo[(row.names(mim_WU_Inland_rhizo) %in% list), ]
#Finally, do Adonis test
set.seed(1)
...
mim_WU_Inland_rhizo_Inlandeco<-mim_WU_Inland_rhizo[(row.names(mim_WU_Inland_rhizo) %in% list), ]
#Finally, do Adonis test
set.seed(1)
...
mim_WU_Coastal_rhizo_coastaleco<-mim_WU_Coastal_rhizo[(row.names(mim_WU_Coastal_rhizo) %in% list), ]
#Finally, do Adonis test
set.seed(1)
...
mim_WU_Coastal_rhizo_Inlandeco<-mim_WU_Coastal_rhizo[(row.names(mim_WU_Coastal_rhizo) %in% list), ]
#Finally, do Adonis test
set.seed(1)
