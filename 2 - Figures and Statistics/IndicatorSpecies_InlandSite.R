...
mim_otu_inlandrhizo <- subset(mim_otu, select=c(rownames(subset(mim_envir, Rhizo_Bulk =="Rhizo" & Site_planted=="Inland"))))
...
mim_envir_inlandrhizo <- mim_envir[c(rownames(subset(mim_envir, Rhizo_Bulk =="Rhizo" & Site_planted=="Inland"))),]
...
inlandeco_inland <- subset(mim_otu, select =c(rownames(subset(mim_envir_inlandrhizo, Origin=="Inland"))))

#next subset the inland metadata for coastal ecotypes only
coastaleco_inland <- subset(mim_otu, select =c(rownames(subset(mim_envir_inlandrhizo, Origin=="Coastal"))))
